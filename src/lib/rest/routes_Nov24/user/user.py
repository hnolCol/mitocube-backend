...
def rest_get_user_profile(session: RestSessionInformation = Depends(RestPermissionSteward())):
    pass  # ToDo: implement router.get("/{username}")

@router.get("/{username}/detailed")  # , response_model=AttributeResponseModel)
def rest_get_detailed_user_profile(session: RestSessionInformation = Depends(RestPermissionSteward())):
    pass  # ToDo: implement router.get("/{username}/detailed")

@router.post("/{username}")  # , response_model=AttributeResponseModel)
def rest_post_update_user_profile(session: RestSessionInformation = Depends(RestPermissionSteward())):
    pass  # ToDo: implement router.post("/{username}")

@router.post("/{username}/pw")  # , response_model=AttributeResponseModel)
def rest_post_update_user_password(session: RestSessionInformation = Depends(RestPermissionSteward())):
    pass  # ToDo: implement router.post("/{username}/pw")

@router.get("/{username}/image")  # , response_model=AttributeResponseModel)
def rest_get_user_image(session: RestSessionInformation = Depends(RestPermissionSteward())):
    pass  # ToDo: implement router.get("/{username}/image")

@router.post("/{username}/image")  # , response_model=AttributeResponseModel)
def rest_post_user_image(session: RestSessionInformation = Depends(RestPermissionSteward())):
...
def rest_delete_deactivate_user_profile(session: RestSessionInformation = Depends(RestPermissionSteward())):
