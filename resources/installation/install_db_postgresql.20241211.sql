...
-- ---------------------------------------------------------------------------------------------------------------------
-- Setup Features and relates Tables
-- ---------------------------------------------------------------------------------------------------------------------
...
CREATE TABLE organisms (
    ...
    mnemonic_name character varying NOT NULL,
...
ALTER TABLE organisms OWNER TO postgres;

CREATE INDEX index_organisms_pk ON organisms USING btree(id);


CREATE TABLE proteomes (
    id serial NOT NULL,
    proteome_id character varying NOT NULL,
    organism_id int NOT NULL,
    status character varying,
    comment character varying,
    PRIMARY KEY(id),
    FOREIGN KEY(organism_id) REFERENCES organisms(id) ON UPDATE CASCADE ON DELETE RESTRICT,
    UNIQUE(proteome_id)
);
ALTER TABLE proteomes OWNER TO postgres;

CREATE INDEX index_proteomes_pk ON organisms USING btree(id);
...
CREATE TABLE feature_pgs (
    ...
    is_reviewed character varying,
    PRIMARY KEY(id),
    FOREIGN KEY(proteome_id) REFERENCES proteomes(id) ON UPDATE CASCADE ON DELETE RESTRICT,
...
CREATE INDEX index_feature_pgs_proteome_fk ON feature_pgs USING btree(proteome_id);
CREATE INDEX index_feature_pgs_organism_fk ON feature_pgs USING btree(organism_id);
...
CREATE TABLE attributes (
    ...
    values_are_genotype_labels boolean DEFAULT false NOT NULL,
